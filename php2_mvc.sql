...
--
-- Host: localhost:3306
-- Generation Time: Feb 16, 2024 at 11:00 AM
...
(3, 'Nội Bài', 'Phú Minh, Sóc Sơn, Hà Nội', '2024-01-26 14:37:23', NULL),
(4, 'Đà Lạt', 'Đường Duy Tân, Phường Hòa Thuận Tây, Quận Hải Châu, Thành phố Đà Nẵng.', '2024-01-31 15:31:32', '2024-02-16 03:56:38');
...
INSERT INTO `flights` (`id`, `airline_id`, `seat`, `price`, `departure_airport_id`, `arrival_airport_id`, `departure_datetime`, `arrival_datetime`, `status`, `created_at`, `update_at`) VALUES
...
(3, 2, 150, 500000, 3, 2, '2024-01-27 22:14:00', '2024-01-28 14:14:00', 1, NULL, NULL);
